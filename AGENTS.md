...
## Key References
- Business brain: `C:/Users/ELITEX21012G2/Projects/business-brain/AGENTS.md`
...
- Global instructions: `C:/Users/ELITEX21012G2/.Codex/AGENTS.md`

## Working agreement

Behavioral rules for this workspace come from the global Working Agreement at `C:/Users/ELITEX21012G2/.Codex/AGENTS.md`. This file only holds BridgeWorks-specific context.
...
| Build Brief (multilayer prompt builder) | Active — lives on Codex for now | Positioning question deferred (personal tool vs service offering) |

### Ventures — parked (revisit when Bridgeworks is stable)

DanubeGold Agri · VeriCrop · MindOfAKing build work · JHU Agentic AI program · the older "AI competitive intelligence platform" positioning in `bridgeworks-workspace/AGENTS.md`.
...
| Old BridgeWorks repo AGENTS.md positioning | Rewrite to match agency positioning | Before next Codex session on that repo |
...
### 2026-04-23
- Closed: AGENTS.md rollout across 5 repos + global + Drive reference; Bridgeworks Financial Tracker uploaded to 05 - Finance & Admin; BridgeWorks repo positioning aligned with live site
- Opened: (none)
